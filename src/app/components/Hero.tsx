...
export function Hero() {
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 pt-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Exploring creativity through color, form, and emotion
          </motion.p>
          <motion.button 
            onClick={() => {
